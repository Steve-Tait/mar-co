import { TestimonialStoryblok, TestimonialWysiwygStoryblok } from "@/component-types-sb";
...
const TestimonialWysiwyg = ({ blok }: TTestimonialWysiwygStoryblokWithRelations) => {
