...
const SectionWrap: React.FC<IProps> = ({ eyebrow, heading, body, children, className, headingLevel = 2, ...props }) => {
	return (
		<div className={cn("group flex flex-col gap-y-6 md:gap-y-10", className)} {...props}>
