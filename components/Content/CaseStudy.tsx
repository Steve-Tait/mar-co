...
const CaseStudy = ({ blok, id }: CaseStudyStoryblok & StoryblokStory<CaseStudyStoryblok>) => {
	const { title, image, excerpt, wysiwyg, disclaimer, industry, logo, body } = blok;
	return (
		<main {...storyblokEditable(blok)}>
			<LayoutScaler>
				<HeroSecondary {...{ title, excerpt, image, industry, disclaimer, logo }} />
