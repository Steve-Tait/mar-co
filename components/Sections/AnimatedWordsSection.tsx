...
export default function AnimatedWordsSection({ blok }: AnimatedWordsSectionStoryblok) {
		...
		<Section blok={blok}>
			<Container className="text-center">
				...
				<Heading level={3} className="h1">
					{heading}
					<TextTransition springConfig={presets.wobbly} className="justify-center text-highlight">
