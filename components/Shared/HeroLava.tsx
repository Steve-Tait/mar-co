...
const HeroLava = ({ title, excerpt, image, categories, className = "", ...props }: THero) => {
	return (
		<section
		...
		>
			<div className="absolute inset-0 overflow-hidden">
				<Lava color1="#270965" color2="#420fa9" className="absolute -inset-1/2 h-[200%] w-[200%] mix-blend-soft-light" />
			</div>
			<Container className="relative text-center">
				<div className="mx-auto max-w-prose">
					...
					{excerpt && <p className="mt-8 text-lg/relaxed md:text-xl/relaxed">{excerpt}</p>}
				</div>
			</Container>
		</section>
	);
};
export default HeroLava;
